...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `status` VALUES (1,'ok','Okay','Everything is awesome.','green',1,1,1426702913,1426702913),(2,'minorproblem','Problems','We\'re experiencing problems with the server, which we are looking in to at the moment','amber',10,0,1426702913,1426702913),(3,'epicfail','Epic fail','Something has gone horribly, terribly wrong. It may even involve a zombie apocalypse.','red',20,0,1426702913,1426702913),(4,'maintenance','Planned maintenance','We are performing planned maintenance on some systems.<br><br>There may be brief periods of interruption.','blue',50,0,1426702913,1426702913),(5,'xmas','Merry Christmas!','Merry Christmas and Happy New Year!<br><br>(Everything is awesome, by the way.)','christmas',99,0,1426702913,1426702913),(6,'moodle-upgrade','Moodle Upgrade','Moodle is \'at risk\' all week while we perform an upgrade. Downtime is expected on Monday, Tuesday and Wednesday.','amber',10,0,0,0),(7,'email','Email Problem','There is a problem with the <em>email server</em>. You may not be able to send or receive email at this time, although you may like to try <em>webmail</em>. We are working to resolve the problem as soon as possible.','amber',10,0,0,0),(8,'login','Login Problem','There is a problem with the <em>login server</em>. You may not be able to log in at this time. We are working to resolve the problem as soon as possible.','amber',10,0,0,0),(9,'internet','Internet Connection','There is a problem with the <em>Internet connection</em>. You may not be able to access external websites or resources at this time, although all internal systems should be unaffected. We are working to resolve the problem as soon as possible.','',10,0,0,0),(10,'server-generic','Generic Server Problem','There is a problem with one or more of our servers, which is affecting some of our systems. We are working to resolve the problem as soon as possible.','amber',10,0,0,0),(11,'moodle-maintenance','Moodle Maintenance','We\'re undergoing planned maintenance on the <em>Moodle server or related servers</em>. Moodle may be slow, or completely unavailable.','',10,0,0,0),(12,'phones','Phones Problem','There is a problem with the ShoreTel/VoIP phone system. We are working to resolve the problem as soon as possible.','amber',10,0,0,0),(13,'wireless','Wireless Problem','We are currently experiencing issues with the <em>wireless network</em>. It may be only partially available or unavailable.<br><br>\r\nWe are investigating and aim to resolve the issue as soon as possible.','amber',10,0,0,0);
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
